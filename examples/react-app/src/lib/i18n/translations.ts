...
const hi = {
  ...
  "bet.sendError.toncast.generic": "बेट नहीं लग सकी। कृपया फिर कोशिश करें।",
  "bet.sendError.toncast.SLIPPAGE_DRIFTED": "मूल्य बदल गया — बेट समायोजित करके फिर पुष्टि करें।",
  "bet.sendError.toncast.QUOTE_INFEASIBLE": "वर्तमान ऑड्स या बैलेंस पर यह बेट संभव नहीं।",
  ...
  "bet.sendError.toncast.FINANCIAL_RISK_ACK_REQUIRED": "बेट से पहले वित्तीय जोखिम सूचना पुष्टि करें।",
